...
public class FindTargetSumWays
{
    public static void main(String[] args)
    {
        ...
        System.out.println(s2.findTargetSumWays(nums,target));

        Solution3 s3=new Solution3();
        System.out.println(s3.findTargetSumWays(nums,target));

        Solution4 s4=new Solution4();
        System.out.println(s4.findTargetSumWays(nums,target));
    }
}
...
class Solution2 {
    public int findTargetSumWays(int[] nums, int target) {
        ...
        if (target < 0 && sum < -target) {
            ...
            int[][] dp = new int[nums.length][(flag / 2) + 1];
            ...
            return dp[nums.length - 1][(flag / 2)];
        }
    }
}
...
class Solution4 {
    public int findTargetSumWays(int[] nums, int target) {
        ...
        if (target < 0 && sum < -target) {
            ...
            int[][] dp = new int[nums.length+1][(flag / 2) + 1];
            dp[0][0] = 1;
